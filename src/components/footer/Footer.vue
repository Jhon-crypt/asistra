            ...
            <div class="flex flex-wrap -mx-4 mb-24">
                <div class="w-full xl:w-4/12 px-4 mb-12 xl:mb-0">
                    <a class="inline-block" href="#">
                        <img class="block h-5" src="https://shuffle.dev/asitrastudio-assets/logos/logo-asi.svg" alt="">
                    </a>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="inline-block text-lg text-black" href="#">
                                ...
                                <span
                                    class="inline-block px-2 py-1 text-xs bg-blue-500 text-white uppercase rounded-full">Hiring</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="flex flex-wrap -mx-4 items-center relative">
                <div class="w-full xl:w-4/12 px-4 mb-8 xl:mb-0">
                    <div class="md:flex items-center justify-between">
                            ...
                            <span class="inline-block">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="black" stroke-width="0.9375" stroke-miterlimit="10"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="black" stroke-width="0.9375" stroke-miterlimit="10"></path>
                                    <path d="M0.527344 9H17.4727" stroke="black" stroke-width="0.9375"
                                    ...
                                    <path
                                        ...
                                        stroke="black" stroke-width="0.9375" stroke-miterlimit="10"></path>
                                    <path d="M9 0.527347V17.4727" stroke="black" stroke-width="0.9375"
                                        stroke-miterlimit="10"></path>
                                </svg>
                            </span>
                        ...
                        <div class="-mb-2"><a
                                class="inline-block text-sm mb-2 mr-12 text-coolGray-500 hover:text-coolGray-600"
                                href="#">Terms of Use</a><a
                                class="inline-block text-sm mb-2 text-coolGray-500 hover:text-coolGray-600" href="#">Privacy
                                Policy</a></div>
                    </div>
                </div>
                <div class="hidden md:block md:w-1/2 xl:w-4/12 px-4 xl:text-center mb-8 md:mb-0">
                    <span class="text-sm text-coolGray-500">© 2023 Realestate.co</span>
                </div>
